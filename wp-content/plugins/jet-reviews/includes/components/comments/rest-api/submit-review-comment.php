...
class Submit_Review_Comment extends Base {
	...
	public function permission_callback( $request ) {
		...
		$source_settings = jet_reviews()->settings->get_source_settings_data_by_source_id( $source, $source_id );

		if ( ! array_diff( $user_data['roles'], $source_settings['allowed_roles'] ) ) {
			return true;
		}
	...
	public function callback( $request ) {
		...
		do_action( 'jet-reviews/endpoints/review-comments/submit-review-comment', $args, $insert_id );
