...
<div class="jet-engine-edit-page__fields">
	...
	<div class="cx-vui-panel">
        ...
        <cx-vui-input
            ...
            description="<?php _e( 'Number of items to skip. <b>Note:</b> This option doesn`t work without <b>Number</b>. If you need unlimited query results with offset, please set some extra large number into <b>Number</b> option.', 'jet-reviews' ); ?>"
            :wrapper-css="[ 'equalwidth' ]"
            size="fullwidth"
            name="query_offset"
