                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">New Property Posted</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello
                                                            ...
                                                            The Property "{{property_title}}" is Updated by {{author}} this employer you can review this property as a admin after reviewing you can approved or disapproved as you want. please follow below for all information submitted by user while update property.
