                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello
                                                            ...
                                                            Your Property "{{property_title}}" is Expired you can renew this propertys by login to your Employer account go to Manage Properties &gt; find your propertys from listings "{{property_title}}" Edit your property select package on step 2 and update your property by this ways your propertys will be publish again.

                                                            Visit the <a href="{{dashboard_url}}">property listing dashboard</a> to manage the listing.
