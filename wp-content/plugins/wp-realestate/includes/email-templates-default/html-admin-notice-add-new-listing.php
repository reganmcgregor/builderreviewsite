                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">New Property Posted</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello
                                                            ...
                                                            New Property "{{property_title}}" is Posted by {{author}} this user you can review this property as a admin after reviewing you can approved or disapproved as you want. please follow below for all information submitted by user while posting new property.
                                                            <h5>Posted Property Information</h5>
                                                            <table class="blueTable">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="text-align: center;" colspan="2">Property Information</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>publish date</td>
                                                                        <td>{{property_publish_date}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>expiry date</td>
                                                                        <td>{{property_expiry_date}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>featured</td>
                                                                        <td>{{property_featured}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>posted by</td>
                                                                        <td>{{author}}</td>
