...
class WP_RealEstate_Fields_Manager {
    ...
    public static function output() {
        ...
        <form class="property-manager-options" method="post" action="">
    ...
    public static function get_custom_fields_data() {
        ...
        return apply_filters( 'wp-realestate-get-custom-fields-data', get_option($meta_key, array()) );
    }

    public static function get_custom_fields_key() {
        return apply_filters( 'wp-realestate-get-custom-fields-key', 'wp_realestate_fields_data' );
    }
