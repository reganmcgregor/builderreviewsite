...
class WP_RealEstate_Wc_Paid_Listings_Cart {
	...
	public static function init() {
		...
		if ( WP_RealEstate_Wc_Paid_Listings_Mixes::is_woocommerce_subscriptions_pre( '4.0.0' ) ) {
			add_action( 'woocommerce_property_package_subscription_add_to_cart', 'WC_Subscriptions::subscription_add_to_cart', 30 );
		} else {
			add_action( 'woocommerce_property_package_subscription_add_to_cart', 'WCS_Template_Loader::get_subscription_add_to_cart', 30 );
		}
