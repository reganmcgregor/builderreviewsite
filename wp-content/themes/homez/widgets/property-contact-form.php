...
if ( !empty($post->post_type) && $post->post_type == 'property' ) {
	...
	?>	
		...
		<div class="contact-form-agent <?php echo esc_attr(!empty($style) ? $style : ''); ?>">
			    ...
			    <div id="click-popup-contact" class="mfp-hide">
			    	<div class="popup-property-contact">
					    ...
					    <form method="post" action="?" class="contact-form-wrapper form-theme">
					    	<div class="row">
						        <div class="col-12">
							        <div class="form-group">
							        	<label for="contact-form-name-<?php echo esc_attr($rand_id); ?>" class="for-control"><?php esc_attr_e( 'Name', 'homez' ); ?></label>
							            <input id="contact-form-name-<?php echo esc_attr($rand_id); ?>" type="text" class="form-control" name="name" required="required">
							        </div><!-- /.form-group -->
							    </div>
							    <div class="col-12">
							        <div class="form-group">
							        	<label for="contact-form-email-<?php echo esc_attr($rand_id); ?>" class="for-control"><?php esc_attr_e( 'Email', 'homez' ); ?></label>
							    ...
							    <div class="col-12">
							        <div class="form-group">
							        	<label for="contact-form-phone-<?php echo esc_attr($rand_id); ?>" class="for-control"><?php esc_attr_e( 'Phone', 'homez' ); ?></label>
					        ...
					        <div class="form-group">
					        	<label for="contact-form-message-<?php echo esc_attr($rand_id); ?>" class="for-control"><?php esc_attr_e( 'Message', 'homez' ); ?></label>
					        ...
					        <button class="button btn btn-theme w-100" name="contact-form"><?php echo esc_html__( 'Send Message', 'homez' ); ?><i class="flaticon-up-right-arrow next"></i></button>

					        <!-- whatsapp -->
					        <?php
			                if ( $whatsapp ) {
			                    ?>
			                    <a class="btn btn-green btn-outline btn-whatsapp w-100" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr($whatsapp); ?>&text=Hello"><?php esc_html_e('Whatsapp', 'homez'); ?><i class="flaticon-up-right-arrow next"></i></a>
			                    <?php
			                }
			                ?>
					    </form>
				...
				<form method="post" action="?" class="contact-form-wrapper form-theme">
					...
					<?php } ?>
			      	...
			      	<div class="action-bottom">
		                ...
		                if ( $whatsapp ) {
		                    ?>
		                    <a class="btn btn-green btn-outline btn-whatsapp w-100" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr($whatsapp); ?>&text=Hello" target="_blank"><?php esc_html_e('Whatsapp', 'homez'); ?><i class="flaticon-up-right-arrow next"></i></a>
		                    <?php
		                }
		                ?>
	                </div>
