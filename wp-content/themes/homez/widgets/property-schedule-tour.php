        ...
        <div class="inner">
            <form method="post" action="?" class="schedule-a-tour-form-wrapper form-theme">
                ...
                <div class="form-group">
                    <input id="schedule-form-date-<?php echo esc_attr($rand_id); ?>" type="text" placeholder="<?php esc_html_e( 'Date', 'homez' ); ?>" class="form-control" name="date" required="required" data-date_format="<?php echo esc_attr(get_option('date_format')); ?>">
                </div><!-- /.form-group -->
            
                <div class="form-group">
                    <select id="schedule-form-time-<?php echo esc_attr($rand_id); ?>" class="form-control" name="time" required="required">
                        <option value=""><?php esc_html_e( 'Time', 'homez' ); ?></option>
                ...
                <div class="form-group">
                    <input id="schedule-form-name-<?php echo esc_attr($rand_id); ?>" type="text" placeholder="<?php esc_html_e( 'Name', 'homez' ); ?>" class="form-control" name="name" required="required">
                </div><!-- /.form-group -->
            
                <div class="form-group">
                    <input id="schedule-form-phone-<?php echo esc_attr($rand_id); ?>" type="text" placeholder="<?php esc_html_e( 'Phone', 'homez' ); ?>" class="form-control" name="phone" required="required" value="<?php echo esc_attr($phone); ?>">
                </div><!-- /.form-group -->
            
                <div class="form-group">
                    <input id="schedule-form-email-<?php echo esc_attr($rand_id); ?>" type="email" placeholder="<?php esc_html_e( 'Email', 'homez' ); ?>" class="form-control" name="email" required="required" value="<?php echo esc_attr($email); ?>">
                </div><!-- /.form-group -->
           
                <div class="form-group space-30">
                    <textarea id="schedule-form-message-<?php echo esc_attr($rand_id); ?>" class="form-control" placeholder="<?php esc_html_e( 'Message', 'homez' ); ?>" name="message"></textarea>
                </div><!-- /.form-group -->
                ...
                <button class="button btn btn-theme w-100" name="schedule-a-tour-form"><?php esc_html_e( 'SUBMIT A TOUR REQUEST', 'homez' ); ?><i class="flaticon-up-right-arrow next"></i></button>
            </form>
        </div>
