jQuery(document).ready(function($){
    ...
    $("body").on("wp_realestate_all_loading_icons", function(){
        homez_get_awesome_icons();
        homez_get_flaticon_icons();
        homez_get_themify_icons();
    ...
    function homez_get_awesome_icons() {
    ...
    function homez_get_flaticon_icons() {
        ...
        for( var i=0; i < files.length; i++ ){
            css = Array.prototype.map.call( files[i].sheet.cssRules, homez_css_text ).join('\n');
    ...
    function homez_get_themify_icons() {
