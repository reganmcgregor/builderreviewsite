...
function homez_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('homez_theme_options[blog_archive_top_categories]', array(
        'capability' => 'edit_theme_options',
        'type'       => 'option',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('homez_theme_options_blog_archive_top_categories', array(
        'settings' => 'homez_theme_options[blog_archive_top_categories]',
        'label'    => esc_html__('Show Blog Categories', 'homez'),
        'section'  => 'apus_settings_blog_archive',
        'type'     => 'checkbox',
    ));
