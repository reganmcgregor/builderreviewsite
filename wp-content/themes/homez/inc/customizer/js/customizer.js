jQuery( document ).ready(function($) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		if ( bodyfontcontrol.homezfontslist[selectedFont] ) {
			$.each(bodyfontcontrol.homezfontslist[selectedFont].variants, function(val, text) {
		...
		if ( bodyfontcontrol.homezfontslist[selectedFont] ) {
			$.each(bodyfontcontrol.homezfontslist[selectedFont].subsets, function(val, text) {
		...
		homezGetAllSelects($(this).parent().parent());
	});
	...
	function homezGetAllSelects($element) {
		var selectedFont = {
