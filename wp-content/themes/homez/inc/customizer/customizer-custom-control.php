...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Homez_WP_Customize_Radio_Image_Control extends WP_Customize_Control {
        public $type = 'homez_radio_image';
    ...
    class Homez_WP_Customize_Heading_Control extends WP_Customize_Control {
        public $type = 'homez_heading';
