...
class Homez_Elementor_User_Header_Notification extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Message Notification', 'homez' );
    }
...
Elementor\Plugin::instance()->widgets_manager->register( new Homez_Elementor_User_Header_Notification );