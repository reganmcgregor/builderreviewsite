...
class Homez_Elementor_Social_Links extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Social Links and Information', 'homez' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'tel',
            [
                'label' => esc_html__( 'Telephone', 'homez' ),
                'type' => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'homez' ),
	...
	protected function render() {
        ...
        <div class="widget-socials d-flex align-items-center <?php echo esc_attr($el_class.' '.$style); ?>">
            <?php if ( !empty($title) ) { ?>
...
Plugin::instance()->widgets_manager->register( new Homez_Elementor_Social_Links );