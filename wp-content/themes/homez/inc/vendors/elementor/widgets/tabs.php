...
class Homez_Elementor_Tabs extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Tabs', 'homez' );
    }
    ...
    protected function register_controls() {
        ...
        $tabs->add_control(
            'content_type',
            [
                'label'       => esc_html__( 'Content Type', 'homez' ),
                'type'        => Controls_Manager::SELECT,
                'default'     => 'template',
                'options'     => [
                    'template' => esc_html__( 'Template', 'homez' ),
                    'editor'   => esc_html__( 'Editor', 'homez' ),
                ],
                'label_block' => 'true',
            ]
        );
        ...
        $tabs->add_control(
            ...
            [
                ...
                'default'    => esc_html__( 'Tab Item Content', 'homez' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition'   => [
        ...
        $this->add_control(
            'title', [
                'label' => esc_html__( 'Title', 'homez' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Enter title here' , 'homez' ),
                'label_block' => true,
            ]
        );
                                ...
                                switch ( $tab[ 'content_type' ] ) {
                                    case 'template':
                                        ...
                                        if ( '0' !== $tab['item_template_id'] ) {
                                            $item_template_id = homez_get_lang_post_id($tab['item_template_id'], 'elementor_library');
...
Plugin::instance()->widgets_manager->register( new Homez_Elementor_Tabs );