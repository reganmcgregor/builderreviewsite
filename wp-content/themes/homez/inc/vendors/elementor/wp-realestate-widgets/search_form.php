...
class Homez_Elementor_RealEstate_Search_Form extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Properties Search Form', 'homez' );
    }
...
Elementor\Plugin::instance()->widgets_manager->register( new Homez_Elementor_RealEstate_Search_Form );