...
class Homez_Widget_Socials_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'homez'),
            array( 'description' => esc_html__( 'Socials for website.', 'homez' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'homez-admin', get_template_directory_uri().'/js/admin.js', array( 'jquery' ), '1.0', true );
    }
    ...
    public function form( $instance ) {
        ...
        $styles = array(
            esc_html__('Style 1', 'homez') => 'style1',
            esc_html__('Style 2', 'homez') => 'style2'
        );
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'homez'); ?></label>
            <br>
        <?php
...
call_user_func( implode('_', array('register', 'widget') ), 'Homez_Widget_Socials_Widget' );