...
class Homez_Widget_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'homez'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'homez' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Homez_Widget_Search' );