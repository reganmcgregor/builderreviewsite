...
class Homez_Widget_User_Short_Profile extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_user_short_profile',
            esc_html__('Apus User Short Profile', 'homez'),
            array( 'description' => esc_html__( 'Show User Short Profile in sidebar', 'homez' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $custom_menus = array( '' => esc_html__('Choose a menu', 'homez') );
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_agent')); ?>">
                <?php echo esc_html__('Agent Account Menu:', 'homez' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_agency')); ?>">
                <?php echo esc_html__('Agency Account Menu:', 'homez' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_user')); ?>">
                <?php echo esc_html__('User Account Menu:', 'homez' ); ?>
            </label>
            <br>
...
call_user_func( implode('_', array('register', 'widget') ), 'Homez_Widget_User_Short_Profile' );