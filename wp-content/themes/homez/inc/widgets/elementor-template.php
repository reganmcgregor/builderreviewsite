...
class Homez_Widget_Elementor_Template extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_elementor_template',
            esc_html__('Apus Show Elementor Template Widget', 'homez'),
            array( 'description' => esc_html__( 'Show Elementor Template', 'homez' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('item_template_id')); ?>">
                <?php echo esc_html__('Choose Template:', 'homez' ); ?>
            </label>
            <br>
...
call_user_func( implode('_', array('register', 'widget') ), 'Homez_Widget_Elementor_Template' );