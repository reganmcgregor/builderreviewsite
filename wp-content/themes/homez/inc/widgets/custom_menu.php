...
class Homez_Widget_Custom_Menu extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'homez'),
            array( 'description' => esc_html__( 'Show custom menu', 'homez' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'homez' ); ?>
            </label>
            <br>
...
call_user_func( implode('_', array('register', 'widget') ), 'Homez_Widget_Custom_Menu' );