...
<article <?php post_class('post post-layout post-list-item'); ?>>
    <div class="list-inner">
        ...
        <div class="col-content position-relative">
            ...
            <?php } ?>
            <div class="description d-xl-block d-none"><?php echo homez_substring( get_the_excerpt(),25, '...' ); ?></div>
            <div class="description d-xl-none d-block"><?php echo homez_substring( get_the_excerpt(),15, '...' ); ?></div>
        </div>
    </div>
</article>