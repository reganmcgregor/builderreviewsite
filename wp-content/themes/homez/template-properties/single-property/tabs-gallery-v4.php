        ...
        <div class="container">
            <ul class="nav nav-tabs nav-table">
                ...
                <?php if ( !empty($latitude) && !empty($longitude) ) : ?>
                    <li>
                        <a href="#tab-gallery-map-map" data-bs-toggle="tab" class="tab-google-map <?php echo esc_attr($active == 'map' || ( !has_post_thumbnail() && empty($gallery) && $active == 'gallery' ) ? 'active' : ''); ?>">
        ...
        <div class="tab-content tab-content-descrip">
            ...
            <?php if ( has_post_thumbnail() || !empty( $gallery ) ) : ?>
                <div id="tab-gallery-map-gallery" class="tab-pane fade <?php echo esc_attr($active == 'gallery' ? 'show active' : ''); ?>">
                    ...
                    echo WP_RealEstate_Template_Loader::get_template_part('single-property/gallery-v9', $args);
                    ?>
                </div>
            <?php endif; ?>
