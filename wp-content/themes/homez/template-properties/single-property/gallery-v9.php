...
if ( has_post_thumbnail() || ($gallery && is_array($gallery)) ) {
    $gallery_size = !empty($gallery_size) ? $gallery_size : '1170x680';
?>
<div class="property-detail-gallery v9">
    <div class="inner">
        <div class="slick-carousel no-gap" data-carousel="slick" data-items="1" data-large="1" data-medium="1" data-small="1" data-smallest="1" data-pagination="false" data-nav="true" data-infinite="true" data-autoplay="true">
