...
<article <?php post_class('map-item property-list property-item'); ?> <?php homez_property_item_map_meta($post); ?> <?php homez_property_display_gallery($post, 'homez-property-list'); ?>>
    <div class="d-sm-flex align-items-center">
        ...
        <div class="top-info flex-grow-1">
            <div class="property-information">
                ...
                <?php } ?>
                <div class="description"><?php echo homez_substring( get_the_excerpt(),16, '...' ); ?></div>
            </div>
