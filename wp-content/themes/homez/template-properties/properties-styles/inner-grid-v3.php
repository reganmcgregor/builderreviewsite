...
<article <?php post_class('map-item property-grid v3 property-item'); ?> <?php homez_property_item_map_meta($post); ?> <?php homez_property_display_gallery($post, 'homez-property-grid'); ?>>
