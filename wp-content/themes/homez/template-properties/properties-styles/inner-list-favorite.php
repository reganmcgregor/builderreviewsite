...
<article <?php post_class('map-item property-grid property-item'); ?> >

    <div class="property-thumbnail-wrapper">
            <a href="javascript:void(0)" class="btn-remove-property-favorite btn-action-icon" data-property_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-realestate-remove-property-favorite-nonce' )); ?>"><i class="flaticon-bin"></i></a>
