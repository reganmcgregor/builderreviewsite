...
<article <?php post_class('map-item property-grid v10 property-item'); ?> <?php homez_property_item_map_meta($post); ?> <?php homez_property_display_gallery($post, 'homez-property-grid-lg'); ?>>

    <div class="property-thumbnail-wrapper">
            <?php homez_property_display_image( $post, 'homez-property-grid-lg' ); ?>
            <?php
            ...
            <?php homez_property_display_author($post); ?>
        </div>
