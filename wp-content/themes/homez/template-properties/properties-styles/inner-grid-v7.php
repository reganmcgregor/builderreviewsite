...
<article <?php post_class('map-item property-grid v7 property-item'); ?> <?php homez_property_item_map_meta($post); ?> <?php homez_property_display_gallery($post, 'homez-property-grid'); ?>>
    ...
    <div class="top-info">
        <div class="property-information">
            ...
            <div class="d-flex align-items-center info-bottom">
                ...
                <?php } ?>
                <div class="ms-auto"><?php homez_property_display_price($post, 'no-icon-title', true); ?></div>
            </div>
    	</div>
    </div>
</article><!-- #post-## -->
