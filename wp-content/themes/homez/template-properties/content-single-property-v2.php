...
<article id="post-<?php the_ID(); ?>" <?php post_class('property-single-layout property-single-v2'); ?>>
	<div class="property-detail-header-wrapper d-flex w-100">
		<div class="<?php echo apply_filters('homez_property_content_class', 'container');?>">
			...
			<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/gallery-v2' ); ?>
	...
	<div class="<?php echo apply_filters('homez_property_content_class', 'container');?>">
		...
		<div class="content-property-detail">
			...
			<div class="row property-v-wrapper">
				<div class="col-12 property-detail-main col-lg-<?php echo esc_attr( is_active_sidebar( 'property-single-v3-sidebar' ) ? 8 : 12); ?>">
