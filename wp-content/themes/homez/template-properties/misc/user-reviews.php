...
<div class="user-reviews">
	<h1 class="title-profile"><?php esc_html_e( 'Reviews', 'homez' ) ; ?></h1>
	<div class="box-white-dashboard">
		<h1 class="title"><?php esc_html_e( 'All Reviews', 'homez' ) ; ?></h1>
		<?php
		if ( $comments ) {
			...
			<div class="not-found"><?php esc_html_e('No reviews found.', 'homez'); ?></div>
		<?php } ?>
	</div>
</div>