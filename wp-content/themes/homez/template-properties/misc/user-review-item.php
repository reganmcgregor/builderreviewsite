...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="the-comment">
		<div class="clearfix">
			<div class="avatar">
				<?php echo homez_get_avatar( $comment->user_id, '70', '' ); ?>
			</div>
				...
				<div class="clearfix">
					...
					<div class="d-flex align-items-center">
						<?php if ( $comment->comment_approved == '0' ) : ?>
							<span class="date"><em><?php esc_html_e( 'Your comment is awaiting approval', 'homez' ); ?></em></span>
						<?php else : ?>
							<span class="date">
						...
						<?php endif; ?>
						<div class="ms-auto">
							<div class="star-rating" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'homez' ), $rating ) ?>">
