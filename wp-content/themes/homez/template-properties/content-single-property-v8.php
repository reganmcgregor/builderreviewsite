...
<article id="post-<?php the_ID(); ?>" <?php post_class('property-single-layout property-single-v8'); ?>>
	
	<div class="property-detail-header-wrapper d-flex w-100">
		<div class="container">
			<!-- Content header -->
			<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/header' ); ?>

			<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/gallery-v6', array('gallery_size' => '1170x550','version_single' => 'v8') ); ?>
		</div>
	</div>
