...
<article id="post-<?php the_ID(); ?>" <?php post_class('property-single-layout property-single-v10'); ?>>
	
	<div class="<?php echo apply_filters('homez_property_content_class', 'container');?>">
		<!-- Content header -->
		<div class="property-detail-header-wrapper">
			<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/gallery-v10' ); ?>
