        ...
        <div class="flex">
            ...
            <div class="agency-information flex-middle <?php echo esc_attr( (!has_post_thumbnail())?'no-image':''); ?>">
                <div class="inner">
                    ...
                    <div class="metas">
                        <?php homez_agency_display_phone($post, 'title'); ?>
                        <?php homez_agency_display_fax($post, 'title'); ?>
                        <?php homez_agency_display_email($post, 'title'); ?>
                        <?php homez_agency_display_website($post, 'title'); ?>
                    </div>
                    ...
                    <div class="agency-information-bottom flex-middle">
                        ...
                        <div class="ali-right hidden">
                            <?php homez_agency_display_socials($post); ?>
