...
<div class="property-submission-preview-form-wrapper">
	...
	<form action="<?php echo esc_url($form_obj->get_form_action());?>" class="cmb-form" method="post" enctype="multipart/form-data" encoding="multipart/form-data">
		...
		<div class="wrapper-action-property">
			<button class="button btn btn-sm btn-theme" name="continue-submit-property"><?php esc_html_e('Submit Property', 'homez'); ?></button>
			<button class="button btn btn-sm btn-danger" name="continue-edit-property"><?php esc_html_e('Edit Property', 'homez'); ?></button>
		</div>
