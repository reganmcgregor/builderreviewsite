...
$sidebar_configs = homez_get_woocommerce_layout_configs();
?>

<?php do_action( 'homez_woo_template_main_before' ); ?>

<section id="main-container" class="<?php echo apply_filters('homez_woocommerce_content_class', 'container');?>">
