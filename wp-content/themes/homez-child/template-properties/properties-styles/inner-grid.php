...
<article <?php post_class('map-item property-grid property-item'); ?> <?php homez_property_item_map_meta($post); ?> <?php homez_property_display_gallery($post, 'homez-property-grid'); ?>>
    ...
    <div class="top-info">
        ...
        <div class="property-metas-bottom d-flex align-items-center">
            <div class="ali-left">
                <?php homez_property_display_type_label($post, true); ?>
            </div>
